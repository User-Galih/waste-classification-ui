...
const ShowcaseSection = () => {
  ...
  // DIUBAH: Menggunakan warna primary (Emerald) untuk tab aktif
  const activeTabStyles = "bg-primary text-white shadow-lg"; 
  const inactiveTabStyles = "bg-white text-slate-500 hover:bg-brand-green"; 

  return (
    <section id="showcase" className="relative py-20 md:py-24 overflow-hidden bg-secondary">
      <div className="container mx-auto px-6 text-center z-10 relative">
        ...
        {/* Navigasi Tab */}
        <div className="flex justify-center border-b-2 border-slate-200 bg-white/50 backdrop-blur-sm rounded-t-lg shadow-inner">
          <button 
      ...
      {/* DIUBAH: Shape Divider dengan tinggi responsif (h-[40px] di HP, h-[100px] di Laptop) */}
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] rotate-180">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-[calc(100%+1.3px)] h-[40px] md:h-[100px]">
              {/* fill-white agar menyatu dengan AboutSection yang berwarna putih */}
